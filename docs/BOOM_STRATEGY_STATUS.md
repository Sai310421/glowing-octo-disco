...
| CB Survivor EA (repro) | `ea/strategies/cb_survivor/CBSurvivor_v1.mq5` | manual-faithful code done (assumptions flagged in README); not compiled/tested | MT5 compile + demo + Phase C |
