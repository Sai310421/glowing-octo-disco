...
| Trend Rider EA | `ea/strategies/boom_trend_rider/BoomTrendRider_v1.mq5` | hardened v1.10 (guards, persistence, kill-switch; XAUUSD-ready auto-calibration + ATR trail); not compiled/tested | MT5 compile + Phase C backtest per symbol |
